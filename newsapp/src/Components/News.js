...
const News = (props) => {
    ...
    const fetchMoreData = async () => {
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=94565befd4ef427b92d8ced9a40eed8a&page=${page+1}&pageSize=${props.pageSize}`;
        setPage(page+1 )
